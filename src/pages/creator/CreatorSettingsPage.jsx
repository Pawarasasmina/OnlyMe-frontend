...
import { FiAward, FiChevronRight, FiLock, FiUser } from "react-icons/fi";
...
export default function CreatorSettingsPage() {
  const rows = [
    ...
    { to: "/creator/verified", icon: FiAward, title: "Verified Creator", text: "Apply for or manage your monthly blue-tick subscription." },
