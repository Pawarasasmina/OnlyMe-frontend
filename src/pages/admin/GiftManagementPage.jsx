...
function GiftPreview({ gift, imageUrl }) {
  return <div className="rounded-2xl border border-slate-200 bg-slate-950 p-4 text-center text-white">
    ...
    <div className="mx-auto grid h-28 w-28 place-items-center overflow-hidden rounded-2xl bg-white/[.06]"><img alt={gift.name || "Gift preview"} className="h-full w-full object-contain" src={imageUrl} style={{ transform: imageTransform(gift) }} /></div>
