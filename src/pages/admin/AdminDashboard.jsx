...
function AdminDashboard() {
  ...
  const moderationQuery = useQuery({ queryKey: ["admin", "dashboard", "pending-planets"], queryFn: () => adminPublicationService.list({ status: "PENDING_REVIEW", page: 1, limit: 5 }).then((response) => response.data.data) });
  ...
  const pendingPlanets = moderationQuery.data?.pagination?.total || 0;
  const cards = [
