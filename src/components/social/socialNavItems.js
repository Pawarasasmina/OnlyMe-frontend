import { FiActivity, FiCheckCircle, FiEdit3, FiGrid, FiHome, FiMessageCircle, FiSearch, FiSettings, FiUser } from "react-icons/fi";
...
export const socialPrimaryNavItems = [
  ...
  { label: "Worlds", to: "/seen", icon: FiGrid },
...
export function socialSecondaryNavItems(capabilities) {
  ...
  items.push({ label: "Settings", to: "/settings/profile", icon: FiSettings });
  return items;
}
