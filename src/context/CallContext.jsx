...
export function CallProvider({ children, user }) {
  ...
  return <CallContext.Provider value={{ activeCall: call, startCall }}>
    {children}
    {call && !(call.direction === "OUTGOING" && call.state === "REQUESTED") && createPortal(<div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#06080c] text-white">
