...
export const publicationService = {
  ...
  restorePublication: (id, statusVersion) => axiosInstance.post(`/publications/mine/${id}/restore`, { statusVersion }),
  getExperienceAccessLink: (id) => axiosInstance.get(`/publications/mine/${id}/access-link`),
  requestExperienceAccess: (id, token) => axiosInstance.post(`/publications/${id}/access-requests`, { token }),
  decideExperienceAccess: (id, requestId, approved) => axiosInstance.patch(`/publications/mine/${id}/access-requests/${requestId}`, { approved }),
  ...
  getPoll: (id, chapterId, blockId, params) => axiosInstance.get(`/publications/${id}/chapters/${chapterId}/polls/${blockId}`, { params }),
  votePoll: (id, chapterId, blockId, optionIndex, payload = {}) => axiosInstance.put(`/publications/${id}/chapters/${chapterId}/polls/${blockId}`, { ...payload, optionIndex }),
