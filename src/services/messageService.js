...
export const messageService = {
  ...
  sendGift: (userId, giftId, idempotencyKey, disappearAfterSeconds = null, sourceType = "DIRECT", message = "", visibility = "EVERYONE") => axiosInstance.post(`/messages/conversations/${userId}/gifts`, { giftId, idempotencyKey, disappearAfterSeconds, sourceType, message, visibility }),
